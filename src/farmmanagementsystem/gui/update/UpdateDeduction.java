 ...
 */
public class UpdateDeduction extends javax.swing.JDialog {

    /** Creates new form AddDeduction */
    public UpdateDeduction(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void setDeduction(Deduction deduction) {
        if(deduction.getClaim_id()!=0){
            JOptionPane.showMessageDialog(null, "Claimed Already", "Update Error", JOptionPane.ERROR_MESSAGE);
                error = true;
                return;
        }
    ...
    private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
        ...
        if(confirm("UPDATE DEDUCTION?")){
            DBQuery.deleteDeduction(deduction.getDeduction_id());
            DBQuery.addDeduction(d);
            JOptionPane.showMessageDialog(null, "Saved", "Saved", JOptionPane.INFORMATION_MESSAGE);
            DBQuery.insertLog(user.getUser_id(), "UPDATE DEDUCTION [DEDUCTION ID: "+d.getDeduction_id()+"]");
            dispose();
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UpdateDeduction dialog = new UpdateDeduction(new javax.swing.JFrame(), true);
    ...
    private void setDeduction(){
        jLabelDeductionID.setText(deduction.getDeduction_id()+"");
        dateChooserCombo1.setText(String.format( "%1$tb %1$td, %1$tY\n",deduction.getDate()));
        jComboBox1.setSelectedItem(deduction.getEmployee());
        jFormattedTextField1.setValue(deduction.getAmount());        
    }
}
